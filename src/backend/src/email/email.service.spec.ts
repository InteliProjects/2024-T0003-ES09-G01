...
describe('EmailService', () => {
  ...
  it('should return array of user emails', async () => {
    ...
    const emails = await service.getAllUsersCompanyIdentifier();

    expect(emails).toEqual({
      "allCompanyIdentifier":
        ["victor.carvalho@sou.inteli.edu.br-undefined", "matheus.santos@sou.inteli.edu.br-undefined", "email 1-undefined"],
      "emails": 
        ["victor.carvalho@sou.inteli.edu.br", "matheus.santos@sou.inteli.edu.br", "email 1"]
    });
