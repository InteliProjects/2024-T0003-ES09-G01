    ...
    try {
      ...
      for (const [index, email] of emails.entries()) {
        await this.mailerService.sendMail({
          ...
          text: `Olá! Somos da 99 e gostaríamos de saber a sua opinião sobre o nosso serviço. Por favor, responda a pesquisa no link a seguir: https://survey-front-psi.vercel.app/survey/${allCompanyIdentifier[index]} . Agradecemos a sua colaboração! Atenciosamente, Equipe 99.`,
        });
      }
